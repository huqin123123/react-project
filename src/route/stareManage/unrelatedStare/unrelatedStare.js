...
import {LocaleProvider, Button, Input, Cascader, Table, Form, Pagination, Divider } from 'antd';
import './unrelatedStare.css';
import zhCN from 'antd/lib/locale-provider/zh_CN';
//非关联盯盘，仅显示未关联客户或客户经理的盯盘数据
const option1 = [{
    value: '网络',
    label: '网络',
}, {
